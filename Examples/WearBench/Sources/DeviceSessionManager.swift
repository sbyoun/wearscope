...
// Origin: @Observable in the CameraAccess sample — plain class here since no UI observation is needed.
@MainActor
final class DeviceSessionManager {
  ...
  // cleanup() is called explicitly instead of an isolated deinit (Swift 6.1+).
